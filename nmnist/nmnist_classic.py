# =========================================================================
# Conventional ConvNet NMNIST classfier
...
class cMNIST(nn.Module):
    def __init__(self, batch_size=32, device=0):
        ...
        self.conv1 = nn.Conv2d(10, 32, kernel_size=(5, 5))
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(NMNIST('/share/data', train=True,
    ...
    test_loader = torch.utils.data.DataLoader(NMNIST('/share/data', train=False,
                                              transform=transforms.Compose([
                                                 transforms.ToTensor()])),
    ...
    torch.save(net, "nmnist_det.pt")
    import sys
    num = sys.argv[1]
    np.save("./data/error_nmnist_"+str(num)+"_det", er_)
    np.save("./data/accur_nmnist_"+str(num)+"_det", ac_)
