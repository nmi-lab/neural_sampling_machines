# =========================================================================
# CIFAR10 NSM Allconvnet classifier
...
# from cifar10_classic import allconvnet64
...
class allnsmconvnet64(nn.Module):
    def __init__(self, noise='bernoulli'):
        ...
        self.fc_out = nn.Linear(in_features=N3, out_features=10)
        self.tanh = nn.Tanh()
...
if __name__ == '__main__':
    ...
    torch.save(net, "cifar10_trained_model_full_300_clean.pt")

    ac_, er_ = np.array(ac_), np.array(er_)
    np.save("./data/bnsm_error_cifar10_300_clean", er_)
    np.save("./data/bnsm_accur_cifar10_300_clean", ac_)
