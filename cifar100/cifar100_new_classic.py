# =========================================================================
# CIFAR100 Allconvnet conventional classifier
...
class allconvnet64(nn.Module):
    def __init__(self):
        ...
        self.nin2 = weight_norm(nn.Conv2d(N3, N3, kernel_size=(1, 1),
                                padding=[0, 0]), name='weight', dim=None)
        self.fc_out = weight_norm(nn.Linear(in_features=N3, out_features=100),
                                  name='weight', dim=None)
...
if __name__ == '__main__':
    ...
    torch.save(net, "cifar100_trained_model_full_nonoise.pt")
    ac_, er_ = np.array(ac_), np.array(er_)
    np.save("./det_error_cifar100_noise_nobin", er_)
    np.save("./det_accur_cifar100_noise_nobin", ac_)
